...
export default function Collection() {
    ...
    async function fetchPokemon() {
        ...
        // this specific URL gets the currentPage number of pokemon
        console.log(`https://pokeapi.co/api/v2/pokemon/?limit=${currentPage}&?offset=${selectedRegion}`)
                ...
                <FlatList 
                    ...
                    <Link
                        ...
                        <View style={styles.cardContent}>
                            ...
                            {/* Name */}
                            <Text key={item.name} style={styles.name}>
                            ...
                            {item.types.map((type) => (
                            <Text key={item.name + type.type.name} style={styles.type}>{type.type.name}</Text>
                            ))}
                            </View>
