...
export default function RootLayout() {
  return <Tabs>
    <Tabs.Screen name="index" options={{ title: "Pokédex", tabBarIcon: ({color, size}) => (<MaterialCommunityIcons name="pokeball" size={size} color={color} />) }}></Tabs.Screen>
    ...
    <Tabs.Screen name="favouritePokemon" options={{ title: "Favourite Pokémon", tabBarIcon: ({color, size}) => (<MaterialIcons name="favorite-border" size={size} color={color} />), headerBackButtonDisplayMode: "minimal" }}></Tabs.Screen>
  </Tabs>;
}
